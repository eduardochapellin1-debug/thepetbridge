        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="text-sm text-slate-600 space-y-3">
              <li>
                <Link href="/aviso-legal" className="hover:text-emerald-600 transition-colors">
                  {t('legalNotice')}
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-semibold text-slate-900 mb-4">The Pet Bridge</h4>
            <p className="text-xs text-slate-500 leading-relaxed italic">
              Conectando mascotas y familias en toda Europa.
            </p>
          </div>
        </div>
