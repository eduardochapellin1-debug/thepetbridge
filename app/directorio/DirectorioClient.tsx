      ...
      <div className="mx-auto max-w-6xl px-6 py-10 md:px-10">
        ...
        <section className="mb-6 rounded-2xl border border-sky-100 bg-sky-50/40 p-6 shadow-sm">
          ...
          <p className="leading-7 text-slate-600">
            En The Pet Bridge, te ayudamos a encontrar los mejores recursos.
            Desde residencias caninas en Madrid y Barcelona hasta los seguros de
            viaje para mascotas mas fiables. Nuestro directorio incluye
            hospitales veterinarios 24h y cuidadores de confianza para viajar
            por Europa con seguridad.
          </p>
        </section>
